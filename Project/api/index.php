...
<body>
    <section id="header">
        <a href="index.html"><img src="Products/logo.png" class="logo" width="90"></a>
        <div>
            <ul id="navbar">
    ...
    <div class="text-block">
        <img src="Products/farm.jpg" class="farm-img">
        <div class="text-farm">
    ...
    <section class="products" id="products">
        ...
        <div class="product-slider">
            <div class="box">
                <img src="Products/product1.jpg" alt="image">
                <h3> Product 1 </h3>
            ...
            <div class="box">
                <img src="Products/product2.jpg" alt="image">
                <h3> Product 2 </h3>
            ...
            <div class="box">
                <img src="Products/product3.jpg" alt="image">
                <h3> Product 3 </h3>
            ...
            <div class="box">
                <img src="Products/product4.jpg" alt="image">
                <h3> Product 4 </h3>
            ...
            <div class="box">
                <img src="Products/product5.jpg" alt="image">
                <h3> Product 5 </h3>
            ...
            <div class="box">
                <img src="Products/product6.jpg" alt="image">
                <h3> Product 6 </h3>
    ...
    <div class="heroptext">
        <img src="Products/pexels-photo-5231144.jpeg" class="img-work">
        <div class="text-work">
    ...
    <div class="contain" id="about">
        <img src="Products/farr.jpg" alt="SamyyoImage" width="1200" height="500" class="mission-img">
    ...
    <h1 class="testi-head" id="Testimonials" style="text-align:center">TESTIMONIALS</h1>
    ...
    <section class="contact">
        <div class="contact-info">
            <div class="first-info">
                <img src="Products/logo.png" alt="footer image" height="100px" width="170px">

                <p>farmtopeople17@gmail.com</p>
    ...
    <div class="fourth-info">
        <p>Farm To People © 2023. All Rights Reserved.</p>
